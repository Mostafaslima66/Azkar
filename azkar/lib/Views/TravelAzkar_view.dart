...
class TravelAzkarView extends StatefulWidget {
  const TravelAzkarView({super.key});
  static String id = 'TravelAzkar_view';
  @override
  State<TravelAzkarView> createState() => _TravelAzkarViewState();
}

class _TravelAzkarViewState extends State<TravelAzkarView> {
...
// define the function of selecte time
 Future<void> _selectTime(BuildContext context) async {
  ...
  Future<void> _loadNotificationPreferences() async {
    ...
    setState(() {
      _isNotificationEnabled = prefs.getBool('travelIsNotificationEnabled') ?? false;
      int? hour = prefs.getInt('travelNotificationHour');
      int? minute = prefs.getInt('travelNotificationMinute');
  ...
  Future<void> _saveNotificationPreference(bool value) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool('travelIsNotificationEnabled', value);
  }

  Future<void> _saveTimePreference(TimeOfDay time) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setInt('travelNotificationHour', time.hour);
    await prefs.setInt('travelNotificationMinute', time.minute);
  }
  ...
  Future<void> loadData() async {
    ...
    final dataList =
        box.get('دعاء السفر') as List<String>; // Retrieve as a List<String>
